...
const NODE_TYPES = ["mock", "llm", "negotiate", "scopeGate", "code", "test", "verify", "repair", "approval", "materialize", "executionApproval", "executionDryRun", "execution", "goalPlanner", "attempt", "adaptive"];
